...
class Config(object):
    ...
    CLIENT_SECRET = "avr8Q~_tEr8Asl.z40.uAB0ieoXFrFatv7nrmb5s"
    ...
    CLIENT_ID = "89a5250f-4e75-4442-b1ec-f16b0fbdeeea"
    ...
    SESSION_TYPE = "filesystem"  # Token here cache will be stored in server-side session
